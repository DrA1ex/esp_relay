...
constexpr std::pair<PropEnumT, PropertyMetadata<PropEnumT, PacketEnumT>> __build_entry(
        PropEnumT prop, PacketEnumT packet, uint8_t offset, uint8_t size, const char *mqtt_in_topic, const char *mqtt_out_topic) {
    return std::make_pair(
            prop, PropertyMetadata<PropEnumT, PacketEnumT>{
...
constexpr std::pair<PropEnumT, PropertyMetadata<PropEnumT, PacketEnumT>> __meta_entry_m(
...
template<typename PropEnumT, typename PacketEnumT, typename... Members,
        typename = std::enable_if_t<std::is_enum_v<PropEnumT> && std::is_enum_v<PacketEnumT>>>
constexpr std::pair<PropEnumT, PropertyMetadata<PropEnumT, PacketEnumT>> define_meta_entry(
